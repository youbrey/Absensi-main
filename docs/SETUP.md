...
5. Simpan URL deployment `https://script.google.com/macros/s/<deployment-id>/exec` dan token yang sama di Pengaturan aplikasi. Token disimpan dalam preferensi privat aplikasi; jangan bagikan APK/perangkat yang telah dikonfigurasi kepada pihak tidak berwenang.
